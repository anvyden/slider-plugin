import {ISettings, Orientation, Color} from "../../../src/components/interfaces/interfaces";
...
class DemoBlock {
  ...
  private findAllConfigurationItems(): void {
    ...
    this.step = <HTMLInputElement>this.panel.querySelector('[data-item="step"]')
    this.from = <HTMLInputElement>this.panel.querySelector('[data-item="from"]')
    this.to = <HTMLInputElement>this.panel.querySelector('[data-item="to"]')
    this.orientation = <HTMLInputElement>this.panel.querySelector('[data-item="orientation"]')
    this.color = <HTMLInputElement>this.panel.querySelector('[data-item="color"]')
    this.isRange = <HTMLInputElement>this.panel.querySelector('[data-item="isRange"]')
    this.progressBar = <HTMLInputElement>this.panel.querySelector('[data-item="progressBar"]')
    this.tooltips = <HTMLInputElement>this.panel.querySelector('[data-item="tooltips"]')
    this.labels = <HTMLInputElement>this.panel.querySelector('[data-item="labels"]')
    this.countOfLabels = <HTMLInputElement>this.panel.querySelector('[data-item="countOfLabels"]')
  }
  ...
  private bindEventListeners(): void {
    ...
    this.isRange.addEventListener('change', this.handleIsRangeChange.bind(this))
    this.progressBar.addEventListener('change', this.handleProgressBarChange.bind(this))
    this.tooltips.addEventListener('change', this.handleTooltipsChange.bind(this))
    this.labels.addEventListener('change', this.handleLabelsChange.bind(this))
    this.countOfLabels.addEventListener('change', this.handleCountOfLabelsChange.bind(this))
  }
  ...
  private handleOrientationChange(): void {
    this.sliderRoot.sliderPlugin('setValue', 'orientation', <Orientation>this.orientation.value)
  }
  ...
  private handleProgressBarChange(): void {
    this.sliderRoot.sliderPlugin('setValue', 'hasProgressBar', this.progressBar.checked)
  }

  private handleTooltipsChange(): void {
    this.sliderRoot.sliderPlugin('setValue', 'hasTooltips', this.tooltips.checked)
  }
  ...
  private handleCountOfLabelsChange(): void {
    this.sliderRoot.sliderPlugin('setValue', 'countOfLabels', Number(this.countOfLabels.value))
  }
}
