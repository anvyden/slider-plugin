...
- [`Подключение слайдера и использование`](#Подключение-слайдера-и-использование)
- [`API`](#API)
...
| `countOfLabels`  | number  |      `6`       | Количество подписей шкалы значений (по умолчанию 6). Можно задать от 2 до 6, если значение не попадает в этот диапазон, то ставится значение по умолчанию |
